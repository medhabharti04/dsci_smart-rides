...
# ✅ Lower min_support further
min_support = max(0.0005, 3 / len(basket_encoded))  # Ensures at least 3 occurrences
frequent_routes = apriori(basket_encoded, min_support=min_support, use_colnames=True)

# ✅ Print frequent itemsets
if frequent_routes.empty:
    print("No frequent routes found. Try lowering min_support further.")
else:
    rules = association_rules(frequent_routes, metric="confidence", min_threshold=0.05)  # Even lower confidence threshold
